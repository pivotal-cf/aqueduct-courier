...
func (fake *FakePendingChangesLister) List() (api.PendingChangesOutput, error) {
	fake.listMutex.Lock()
...
func (fake *FakePendingChangesLister) ListCallCount() int {
	fake.listMutex.RLock()
	defer fake.listMutex.RUnlock()
	return len(fake.listArgsForCall)
}

func (fake *FakePendingChangesLister) ListReturns(result1 api.PendingChangesOutput, result2 error) {
	fake.ListStub = nil
...
func (fake *FakePendingChangesLister) ListReturnsOnCall(i int, result1 api.PendingChangesOutput, result2 error) {
	fake.ListStub = nil
