# archiver [![archiver GoDoc](https://img.shields.io/badge/reference-godoc-blue.svg?style=flat-square)](https://pkg.go.dev/github.com/joyvuu-dave/archiver?tab=doc) [![Ubuntu-latest](https://github.com/joyvuu-dave/archiver/actions/workflows/ubuntu-latest.yml/badge.svg)](https://github.com/joyvuu-dave/archiver/actions/workflows/ubuntu-latest.yml) [![Macos-latest](https://github.com/joyvuu-dave/archiver/actions/workflows/macos-latest.yml/badge.svg)](https://github.com/joyvuu-dave/archiver/actions/workflows/macos-latest.yml) [![Windows-latest](https://github.com/joyvuu-dave/archiver/actions/workflows/windows-latest.yml/badge.svg)](https://github.com/joyvuu-dave/archiver/actions/workflows/windows-latest.yml)
...
See <https://pkg.go.dev/github.com/joyvuu-dave/archiver/v3>
...
```bash
go install github.com/joyvuu-dave/archiver/v3/cmd/arc@latest
```
...
1. Download the binary for your platform from the [Github Releases](https://github.com/joyvuu-dave/archiver/releases) page.
...
```bash
go get github.com/joyvuu-dave/archiver/v3
```

```go
import "github.com/joyvuu-dave/archiver/v3"
```

[See the package's GoDoc](https://pkg.go.dev/github.com/joyvuu-dave/archiver?tab=doc) for full API documentation.
...
The archive format is determined by file extension. (There are [several functions in this package](https://pkg.go.dev/github.com/joyvuu-dave/archiver?tab=doc) which perform a task by inferring the format from file extension or file header, including `Archive()`, `Unarchive()`, `CompressFile()`, and `DecompressFile()`.)
...
There's a lot more that can be done, too. [See the GoDoc](https://pkg.go.dev/github.com/joyvuu-dave/archiver?tab=doc) for full API documentation.

**Security note: This package does NOT attempt to mitigate zip-slip attacks.** It is [extremely difficult](https://github.com/rubyzip/rubyzip/pull/376) [to do properly](https://github.com/joyvuu-dave/archiver/pull/65#issuecomment-395988244) and [seemingly impossible to mitigate effectively across platforms](https://github.com/golang/go/issues/20126). [Attempted fixes have broken processing of legitimate files in production](https://github.com/joyvuu-dave/archiver/pull/70#issuecomment-423267320), rendering the program unusable. Our recommendation instead is to inspect the contents of an untrusted archive before extracting it (this package provides `Walkers`) and decide if you want to proceed with extraction.
